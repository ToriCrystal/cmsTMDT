               ...
               <div class="card-body row">
                   ...
                   <div class="col-6">
                        <div class="mb-3">
                            ...
                            <x-input input type="datetime-local" name="date_start" :value="old('date_start')" :required="true" :placeholder="__('date_start')" />
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
                            <label class="control-label">@lang('date_end')</label>
                            <x-input name="date_end" input type="datetime-local" :value="old('date_end')" :required="true" :placeholder="__('date_end')" />
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
                            <label class="control-label">@lang('min_order_amount')</label>
                            <x-input name="min_order_amount" :value="old('min_order_amount')" :required="true" :placeholder="__('min_order_amount')" />
                        </div>
                    </div>
                    <div class="col-6">
                    <div class="mb-3">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <x-input name="discount_value" :value="old('discount_value')" :required="true" :placeholder="__('discount_value')" />
                        </div>
                    </div>
               </div>
           </div>
