...
class StoreCategoryController extends Controller
{
    ...
    public function index(StoreCategoryDataTable $dataTable){
        ...
        return $dataTable->render($this->view['index'], [
            'breadcrums' => $this->crums->add(__('store'))->add(__('category2'))
        ]);
    }
    ...
    public function create(){
        ...
        return view($this->view['create'], [
            ...
            'breadcrums' => $this->crums->add(__('store'))->add(__('category2'), route($this->route['index']))->add(__('add'))
        ]);
    }
    ...
    public function edit($id){
        ...
        return view(
            ...
            [
                'category' => $category, 
                'status' => DefaultStatus::asSelectArray(),
                'breadcrums' => $this->crums->add(__('store'))->add(__('category2'), route($this->route['index']))->add(__('edit'))
            ], 
        );
    }
