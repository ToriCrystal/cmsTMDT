...
use App\Admin\Http\Controllers\Distance\DistanceController;
...
Route::group(['middleware' => 'admin.auth.admin:admin'], function () {
    ...
    Route::prefix('/shops')->as('shop.')->group(function () {

        //store
        Route::controller(App\Admin\Http\Controllers\Store\StoreController::class)->group(function () {
            Route::get('/prioritie', 'prioritie')->name('prioritie');
    ...
    Route::controller(App\Admin\Http\Controllers\Notification\NotificationController::class)
        ...
        ->group(function () {
            Route::get('/add', 'create')->name('create');
            Route::get('/not-read-admin', 'getNotificationsForAdmin')->name('getNotifications');
            Route::get('/not-read-store', 'getNotificationsForStore')->name('getNotificationsForStore');
            Route::post('/add', 'store')->name('store');
            ...
            Route::patch('/status-store', 'updateStatusForStore')->name('updateStatusForStore');
    ...
    //rate
    Route::controller(App\Admin\Http\Controllers\Rate\RateController::class)
        ->prefix('/rates')
        ->as('rates.')
        ->group(function () {
            Route::get('/add', 'create')->name('create');
    ...
    Route::controller(App\Admin\Http\Controllers\Order\OrderController::class)
        ...
        ->group(function () {
            ...
            Route::post('/add', 'store')->name('store');
            Route::get('/', 'index')->name('index');
            Route::get('/order-driver-history/{id}', 'orderDriverHistory')->name('orderDriverHistory');
            Route::get('/get-info', 'getInfoOrder')->name('info');
            Route::get('/edit/{id}', 'edit')->name('edit');
            Route::put('/edit', 'update')->name('update');
            Route::delete('/delete/{id}', 'delete')->name('delete');
        });
    ...
    Route::prefix('/manager-user')->as('user.')->group(function () {
        Route::controller(App\Admin\Http\Controllers\User\UserController::class)->group(function () {
            ...
            Route::get('/', 'index')->name('index');
            Route::get('/edit/{id}', 'edit')->name('edit');
            Route::get('/order-history/{id}', 'orderHistory')->name('orderHistory');
            Route::put('/edit', 'update')->name('update');
            Route::post('/add', 'store')->name('store');
            Route::delete('/delete/{id}', 'delete')->name('delete');
        });
    ...
    //user driver
    Route::prefix('/manager-user-driver')->as('driver.')->group(function () {
        Route::controller(App\Admin\Http\Controllers\UserDriver\UserDriverController::class)->group(function () {
            Route::get('/add', 'create')->name('create');
            Route::get('/', 'index')->name('index');
            Route::get('/new-driver', 'newDrivers')->name('newDriver');
            Route::get('/edit/{id}', 'edit')->name('edit');
            Route::put('/edit', 'update')->name('update');
            Route::post('/add', 'store')->name('store');
            Route::delete('/delete/{id}', 'delete')->name('delete');
    ...
    Route::controller(App\Admin\Http\Controllers\Setting\SettingController::class)
        ...
        ->group(function () {
            ...
            Route::put('/updateAppearance', 'updateAppearance')->name('updateAppearance');
        });
    ...
    Route::prefix('/search')->as('search.')->group(function () {
        Route::prefix('/select')->as('select.')->group(function () {
            ...
            Route::get('/driver', [App\Admin\Http\Controllers\UserDriver\UserDriverSearchSelectController::class, 'selectSearch'])->name('driver');
